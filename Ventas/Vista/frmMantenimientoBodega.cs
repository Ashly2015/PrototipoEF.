...
namespace CapaVistaMVentasCC
{
    public partial class frmMantenimientoBodega : Form
    {
        public frmMantenimientoBodega()
        {
            ...
            navegador1.funLlenarComboControl(cbxTipobodega, "tipoBodega", "pkid", "nombre", "estado");
        ...
        private void cbxTipobodega_SelectedIndexChanged(object sender, EventArgs e)
        {
            navegador1.funComboTextboxVista(cbxTipobodega, txtfkidTipobodega);
        }
    }
}
