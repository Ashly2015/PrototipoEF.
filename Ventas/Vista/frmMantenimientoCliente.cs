...
namespace CapaVistaMVentasCC
{
    public partial class frmMantenimientoCliente : Form
    {
        public frmMantenimientoCliente()
        {
            ...
            navegador1.funAsignarAliasVista(alias, "cliente", "ventas");
            navegador1.funAsignarSalidadVista(this);
            navegador1.funLlenarComboControl(cbxTipocliente, "tipocliente", "idTipo", "nombre", "estatus");
        ...
        {
            navegador1.funComboTextboxVista(cbxTipocliente, txtidTipo);
        }
    }
}
