...
namespace CapaVistaMVentasCC
{
    public partial class frmMantenimientoProducto : Form
    {
        public frmMantenimientoProducto()
        {
            ...
            navegador1.funLlenarComboControl(cbxFkidlinea, "linea ", "idLinea,", "nombre", "Estatus");
        ...
        {
            navegador1.funComboTextboxVista(cbxInventario, txtfkinventario);
        }

        private void cbxFkidlinea_SelectedIndexChanged(object sender, EventArgs e)
        {
            navegador1.funComboTextboxVista(cbxFkidlinea, txtFkidlinea);
        }
    }
}
